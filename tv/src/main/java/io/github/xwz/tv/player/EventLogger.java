package io.github.xwz.tv.player;
 ...
 */
public class EventLogger implements VideoPlayer.Listener, VideoPlayer.InfoListener, VideoPlayer.InternalErrorListener {
    ...
    public EventLogger() {
        loadStartTimeMs = new long[VideoPlayer.RENDERER_COUNT];
    }
    ...
    // VideoPlayer.InternalErrorListener
